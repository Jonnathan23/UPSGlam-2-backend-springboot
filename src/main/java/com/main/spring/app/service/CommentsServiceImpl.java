                ...
                return commentsRepository.createComment(postId, authorUid, text) // 1. CREAR EL COMENTARIO
                                .flatMap(commentId -> {
                                        ...
                                        return postRepository.updateCommentCount(postId, 1)
                                                        .thenReturn("Comentario creado exitosamente con ID: "
                                                                        + commentId); // Devolvemos el mensaje
                                                                                      // final
                                })
                                .doOnSuccess(message -> System.out
                                                .println("LOG: Comentario y contador actualizados exitosamente. Mensaje: "
                                                                + message))
                                .onErrorResume(e -> {
                                        System.err.println(
                                                        "ERROR: Fallo al crear comentario. Causa: " + e.getMessage());
                                        return Mono.error(new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR,
                                                        "Error interno al crear el comentario.", e));
                                });
        }
        ...
        public Mono<String> deleteComment(String postId, String commentId, String authorUid) {
                ...
                return commentsRepository.getCommentById(postId, commentId)
                                ...
                                .flatMap(comment -> {
                                        ...
                                        Mono<Void> deleteCommentMono = commentsRepository.deleteComment(postId,
                                                        commentId);
                                        ...
                                        return deleteCommentMono
                                                        ...
                                                        .doOnSuccess(message -> System.out
                                                                        .println("LOG: Comentario eliminado exitosamente con ID: "
                                                                                        + commentId))
                                                        .onErrorResume(e -> {
                                                                System.err.println(
                                                                                "ERROR: Fallo al eliminar el comentario. Causa: "
                                                                                                + e.getMessage());
                                                                return Mono.error(new ResponseStatusException(
